...
<body>
	...
	<!-- 
<c:forEach items="${products}" var="it">${it.pName}</c:forEach>-->
			...
			<c:forEach items="${products}" var="it">
				...
				<div class="col">
					<div class="card h-100 shadow-sm">
						<img src="${it.imgUrl}" class="card-img-top" alt="...">
						<div class="card-body">
							<div class="clearfix mb-3">
								<span class="float-start badge rounded-pill bg-primary">${it.pName }</span>
							...
							<div class="text-center my-4">
								<a href="AddToCartController?pid=${it.pId}"
